...
namespace testuser.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult Login(string returnUrl)
        {
            ...
            //    if (!roleManager.RoleExists("Prueba"))
            //    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            if (usuario == null)
            {
                ModelState.AddModelError("", "Usuario no registrado, verifique sus credenciales e intente nuevamente");
                return View(model);
            }
            ...
            if (usuario.Estado)
            {
                ...
                switch (result)
                {
                    case SignInStatus.Success:
                        ...
                        notificacion.Module = "Login";
                        notificacion.Message = string.Format("inicio sesion");
            ...
            {
                ModelState.AddModelError("", "Este usuario se encuentra inactivo. Consulte a un administrador para más información");
                return View(model);
            }
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    //var rolresult = UserManager.AddToRole(currentuser.Id, "Administrador");
                    ...
                    /*Almacenar registro de usuario en notificacion*/
                    ApplicationDbContext dbs = new ApplicationDbContext();
                    Notifications notificacion = new Notifications();
                    notificacion.Module = "Usuarios";
                    notificacion.Message = string.Format("se registro correctamente");
                    notificacion.Date = DateTime.Now;
                    notificacion.Viewed = false;
        ...
        public ActionResult LogOff()
        {
            ...
            Notifications notificacion = new Notifications();
            notificacion.Module = "Login";
            notificacion.Message = string.Format("Cerro sesión correctamente");
            notificacion.Date = DateTime.Now;
            notificacion.Viewed = false;
